 ...
 * */
	SELECT *
	FROM MEMBERS JOIN MEMBERS_MOVIE_RENTAL ON MEMBERS.MEMBER_ID = MEMBERS_MOVIE_RENTAL.MEMBER_ID JOIN
...
FROM ACTORS  RIGHT JOIN MOVIES_ACTORS ON ACTORS.ACTOR_ID = MOVIES_ACTORS.ACTOR_ID LEFT JOIN MOVIES ON MOVIES_ACTORS.MOVIE_ID = MOVIES.MOVIE_ID LEFT  JOIN STUDIO ON MOVIES.STUDIO_ID = STUDIO.STUDIO_ID
WHERE STUDIO.STUDIO_ACTIVE = FALSE;

SELECT COUNT(DIRECTORS.DIRECTOR_ID)
